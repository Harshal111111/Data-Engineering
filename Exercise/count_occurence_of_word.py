...
# Create a function called count_word_occurrences that takes a string and a target word as input and returns the number
# of times the target word appears in the string. The function should not be case-sensitive, meaning it should count
# occurrences regardless of the word's case. Your function should use only built-in Python tools.
